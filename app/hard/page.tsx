...
export default function Home() {
    ...
    const [quizSet] = useState(getRandomSongs(2));
        ...
        <main className="mt-10 px-2 max-w-xl min-h-screen mx-auto">
            ...
            {isResult && (
                <div className="mt-10">
                    ...
                    <p className="mt-2 text-center text-xl">難易度: 上級</p>
                    ...
                    <div className="flex items-center justify-center">
                        <Link href={`https://x.com/intent/post?text=${correctCount}点を獲得しました！(上級)%0A&url=https://vocolor.vercel.app%0A&hashtags=背景の色からボカロ曲を当てるゲーム`} target="_blank">
