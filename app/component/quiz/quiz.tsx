        ...
        <main className="mt-10 px-2 max-w-xl min-h-screen mx-auto">
            ...
            {isResult && (
                <div className="mt-10">
                    ...
                    <hr className="mb-4"/>
                    <div className="flex items-center justify-center">
                        <Link href={`https://x.com/intent/post?text=${correctCount}点を獲得しました！(${props.dificultyName})%0A&url=https://vocolor.vercel.app%0A&hashtags=背景の色からボカロ曲を当てるゲーム`} target="_blank">
